...
XCVAR_DEF( g_logChat, "1", NULL, CVAR_NONE, qfalse )
XCVAR_DEF( g_logClientInfo, "0", NULL, CVAR_ARCHIVE, qfalse )
...
XCVAR_DEF( g_saberDmgDelay_Idle, "0", NULL, CVAR_ARCHIVE, qtrue )
...
XCVAR_DEF( japp_adminicon, "gfx/2d/defer", NULL, CVAR_ARCHIVE, qfalse )
...
XCVAR_DEF( japp_allowChatAnimations, "0", NULL, CVAR_ARCHIVE, qtrue )
XCVAR_DEF( japp_allowCloakUnlimitedFuel, "1", NULL, CVAR_ARCHIVE, qtrue )
XCVAR_DEF( japp_allowDFA, "1", CVU_DFA, CVAR_NONE, qtrue )
XCVAR_DEF( japp_allowDropSaber, "0", NULL, CVAR_NONE, qfalse )
...
XCVAR_DEF( japp_allowJetpackUnlimitedFuel, "1", NULL, CVAR_NONE, qtrue )
...
XCVAR_DEF( japp_allowRegistration, "0", NULL, CVAR_ARCHIVE, qtrue )
...
XCVAR_DEF( japp_antiUserinfoFlood, "0", NULL, CVAR_NONE, qfalse )
...
XCVAR_DEF( japp_flipKickDamageInDuel, "0", NULL, CVAR_NONE, qtrue )
...
XCVAR_DEF( japp_gripRoll, "1", NULL, CVAR_NONE, qtrue )
...
XCVAR_DEF( japp_showLaggingClients, "0", NULL, CVAR_NONE, qfalse )
...
XCVAR_DEF( japp_spawnArmor, "25", NULL, CVAR_NONE, qtrue )
XCVAR_DEF( japp_spawnHealth, "125", NULL, CVAR_NONE, qtrue )
...
XCVAR_DEF( japp_unlagged, "0", NULL, CVAR_SERVERINFO, qtrue )
